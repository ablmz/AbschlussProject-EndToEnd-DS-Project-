...
def total_likes():
	t_like = driver.find_elements_by_class_name("section-review-interactions-label")
	
	for i in t_like:
		total=(i.text).strip()
		
		if total =='Gefällt mir':
			# print(total.replace('Gefällt mir','0'))
			print('0 like')
		elif total =='Teilen':
			a = total.replace('Teilen','')
		else:
			print(total, 'like/s')
